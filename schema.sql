...
CREATE TABLE public.project_site (
    id integer NOT NULL,
    geom public.geometry(Point,22717) NOT NULL,
    proj_id integer NOT NULL
);


--
-- Name: project_site_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: statday; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.statday (
...
--
-- Name: statday_holiday_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.statday ALTER COLUMN holiday_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.statday_holiday_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: statday statday_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.statday
    ADD CONSTRAINT statday_pkey PRIMARY KEY (holiday_id);
...
--
-- Name: project_site ukcerl685s0ynn2ekrebsg80g30; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_site
    ADD CONSTRAINT ukcerl685s0ynn2ekrebsg80g30 UNIQUE (proj_id);


--
-- Name: cxlist ukeu90f3qmowfmjpugkl2xc3l7t; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cxlist
    ADD CONSTRAINT ukeu90f3qmowfmjpugkl2xc3l7t UNIQUE (job_id);


--
-- Name: rep uki8ymrljeg3nqsb8r98wrhnfqm; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rep
    ADD CONSTRAINT uki8ymrljeg3nqsb8r98wrhnfqm UNIQUE (rep_name);


--
-- Name: tsuser ukkjejx1uufmdmmg8uvbisjnehp; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tsuser
    ADD CONSTRAINT ukkjejx1uufmdmmg8uvbisjnehp UNIQUE (qb_email);
...
--
-- Name: idx_te_date2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_te_date2 ON public.master2 USING btree (date);


--
-- Name: project_site fk_project; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.project_site
    ADD CONSTRAINT fk_project FOREIGN KEY (proj_id) REFERENCES public.cxlist(proj_id);
