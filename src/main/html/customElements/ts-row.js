...
export class TimeSheetRow extends BaseElement {
    ...
    static init() {  // static block seemed to run before mrsock got imported in main.js
        window.mrsock.registerCallback("GotRow", this.mymessage);
        window.mrsock.registerCallback("CellAdd", this.mymessage);
    }
...
customElements.define('ts-row', TimeSheetRow);
