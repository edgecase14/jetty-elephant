...
import static net.coplanar.controller.GenericController.FEState;
...
//    private final Deque<SseMessage> messageQueue = new ArrayDeque<>();
    ...
    public void init() {
       ...
       // Add cleanup callbacks for state reset
       addStateResetCleanupCallback(() -> TsCellElement.removeAllCells(this));
       addStateResetCleanupCallback(() -> TsCellElement.clearAllCells());
    }

    // Handle LOADING state logic
    @Override
    public void handleLoadingState() throws JsonProcessingException {
        ...
        System.out.println("LOADING: sending objList -> RUNNING");
        writeObjList();
        setFrontendState(FEState.RUNNING);
    }
...
//        }
    ...
    @Override
    public void handleRunningState(UpdateMessage event) throws JsonProcessingException {
        System.out.println("state: RUNNING");
        
        // Handle non-state-dependent events first
        ...
        // Handle running-state-specific events
